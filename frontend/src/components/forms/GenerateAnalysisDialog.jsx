        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center space-x-2">
              <Checkbox id="trends" checked={includeTrends} onCheckedChange={(checked) => setIncludeTrends(checked === true)}/>
              <Label htmlFor="trends">Trend analysis and forecasting</Label>
            </div>

            <div className="flex items-center space-x-2">
              <Checkbox id="recommendations" checked={includeRecommendations} onCheckedChange={(checked) => setIncludeRecommendations(checked === true)}/>
              <Label htmlFor="recommendations">Policy recommendations</Label>
            </div>

            <div className="flex items-center space-x-2">
              <Checkbox id="risk" checked={includeRiskAssessment} onCheckedChange={(checked) => setIncludeRiskAssessment(checked === true)}/>
