        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center space-x-2">
              <Checkbox id="farms" checked={includeFarms} onCheckedChange={(checked) => setIncludeFarms(checked === true)}/>
              <Label htmlFor="farms">Farm information</Label>
            </div>

            <div className="flex items-center space-x-2">
              <Checkbox id="treatments" checked={includeTreatments} onCheckedChange={(checked) => setIncludeTreatments(checked === true)}/>
              <Label htmlFor="treatments">Treatment records</Label>
            </div>

            <div className="flex items-center space-x-2">
              <Checkbox id="compliance" checked={includeCompliance} onCheckedChange={(checked) => setIncludeCompliance(checked === true)}/>
